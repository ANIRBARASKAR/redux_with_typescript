...
const Settings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    //   setmessage("Only SuperAdmin Can Access This Page")
    //   settypeOfAlert("error")
    //   setalertShow(true)
    //   setTimeout(() => {
    //     navigate(-1)
    ...
    <>
      ...
      <div className="settings-wrap">
        <div className="row">
          ...
          <div className="col-lg-4 col-sm-6">
            <h5 className="settings-title">Workspace Type</h5>
            <div className="form-check">
              <input
                ...
                onChange={() => handleChangeType('Two Way')}
                checked={profileDetail?.type == 'Two Way'}
                />
              <label
                ...
                <span className="d-block">
                  You can add multiple teams to the workspace with the ability to
                  have all teams participate in Q&A and uploading documents.
                </span>
              </label>
            </div>
            <div className="form-check">
              <input
                ...
                onChange={() => handleChangeType('One Way')}
                checked={profileDetail?.type == 'One Way'}
              />
              <label
                className="form-check-label"
              ...
              >
                1 way Workspace
                <span className="d-block">
                  You can add multiple teams with only you being able to upload
                  documents, external team will have view-only access to the
                  documents. However, all parties can participate in Q&A.
                </span>
              </label>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6">
            <h5 className="settings-title">Manual Controls</h5>
            <div className="settings-group">
          ...
          <div className="col-lg-4 col-sm-6">
            ...
            <div className="settings-group">
              ...
              <p className="settings-text">{profileDetail?.user?.email}</p>
              <span className="setting-note">
                The participants of the workspace can contact you on this email if
                they need assistance. This information is shown on the home
                page.
              </span>
            </div>
            <div className="settings-group">
              ...
              <p className="settings-text">{profileDetail?.user?.mobile}</p>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6">
            ...
            <div className="form-check form-switch">
              <input
                ...
                checked={profileDetail.user?.setting?.isQANotification}
            ...
            <div className="form-check form-switch">
              <input
                className="form-check-input"
                type="checkbox"
                checked={profileDetail.user?.setting?.isTeamSpecificQA}
                role="switch"
